    ...
    return (
        <>
            ...
            <div className="flex flex-col ">
                <div className="h-[70vh] bg-cover bg-center bg-[url(https://lirp.cdn-website.com/6602115c/dms3rep/multi/opt/college+counseling-1920w.jpg)] ">
                    <div className="h-full  relative w-full bg-black/50 backdrop-blur- flex items-start  justify-start">
                        <div className="flex  flex-col mt-10 justify-center  items-center px-2 text-center">
                            <h1 className="text-white text-xl font-semibold tracking-wide">
                                Acewall Scholars Learning for Teachers: </h1>
                            <div className=" flex items-center justify-center flex-wrap  sm:flex-row flex-col">
                                ...
                                <h2 className="text-white text-md max-w-lg px-4">
                                    Free up some of your time! Let us provide your students with access to informative and engaging video lessons.
                                </h2>
                            </div>
                        </div>
                    </div>
