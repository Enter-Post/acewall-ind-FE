    ...
    <section className="p-3 md:p-0">
      ...
      {courses.length === 0 ? (
        <div className="flex flex-col items-center justify-center ">
          ...
          <img src="https://img.freepik.com/free-vector/college-campus-concept-illustration_114360-10535.jpg?ga=GA1.1.1453766052.1744756388&semt=ais_hybrid&w=740" alt="No courses" className="w-full h-80 object-contain" />
          <p className="text-lg mt-4 text-muted-foreground">No courses created yet.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <Link key={course._id} to={`/teacher/courses/courseDetail/${course._id}`}>
              ...
              <Card className="pb-6 pt-0 w-full overflow-hidden cursor-pointer">
                ...
                <CardHeader>
                  ...
                  <p className="text-xs">Teacher: {course.createdby?.name}</p>
                </CardHeader>
                <CardContent>
