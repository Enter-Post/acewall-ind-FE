    ...
    <Card className="mt-4">
      ...
      <CardContent className="py-2 space-y-4">
        {assessments.map((assessment) => (
          <div key={assessment._id} className="border-l-4 border-blue-400 pl-4 py-2 bg-gray-50 rounded-r-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <DeleteModal what="Assessment" deleteFunc={() => onDelete(assessment._id)} />
              </div>
            </div>
            {assessment.description && <p className="text-sm text-gray-600">{assessment.description}</p>}
          </div>
        ))}
      </CardContent>
    </Card>
