          ...
          >
            ...
            >
              ...
              <div className="w-full space-y-4">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-gray-900">
                  {heading}
                </h2>
                <p className="text-base sm:text-lg md:text-1xl text-gray-600 leading-relaxed max-w-5xl">
                  {text}
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-6">
                  {bulletPoints.map((point, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                      ...
                      <span className="text-sm sm:text-base md:text-base text-gray-800 font-medium leading-snug">
                        {point}
                      </span>
                    </div>
                  ))}
