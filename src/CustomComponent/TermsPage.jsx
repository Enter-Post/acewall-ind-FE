...
export default function TermsPage({ style }) {
  return (
    <section className="bg-white text-gray-800 py-8 px-4" style={style}>
      <p className="text-3xl font-bold text-center">Terms and Conditions</p>
      <p>
        Last updated{" "}
      ...
      <div className="mt-4">
        <div className="text-sm leading-6 pr-4">
          ...
          Acewall Scholars , concerning your access to and use of the Services.
          ...
          to our Services, including code, databases, software, website designs,
          text, images, and trademarks.
          <br />
          <br />
        ...
        licenses to submit such Submissions and that you have full authority to
        grant us the above-mentioned rights in relation to your Submissions ;
        and warrant and represent that your Submissions do not constitute
        ...
        ( 4 ) you are not a minor in the jurisdiction in which you reside ; ( 5
        ...
        Services, please email us at contact@acewallscholars.org .
        <br />
        <br />
        <b>Fee Changes</b>
        <br />
        ...
        the Content contained therein. Disparage, tarnish, or otherwise harm, in
        our opinion, us and/or the Services. Use any information obtained from
        the Services in order to harass, abuse, or harm another person. Make
        ...
        text), that interferes with any party’s uninterrupted use and enjoyment
        ...
        or similar data gathering and extraction tools. Delete the copyright or
        ...
        Services or the networks or services connected to the Services. Harass,
        ...
        the Services. Make any unauthorized use of the Services, including
        ...
        commercial enterprise. Use the Services to advertise or offer to sell
        ...
        and permissions to use and to authorize us, the Services, and other
        ...
        and these Legal Terms. Your Contributions are not false, inaccurate, or
        ...
        <br />
        <br />
        <strong>12. THIRD-PARTY WEBSITES AND CONTENT</strong>
        <br />
        <br />
        ...
        <br />
        <br />
        <strong>13. SERVICES MANAGEMENT</strong>
        <br />
        <br />
        ...
        Policy: https://www.acewallscholarslearningonline.org/privacyPolicy . By
        ...
        <br />
        <br />
        <strong>16. MODIFICATIONS AND INTERRUPTIONS</strong>
        <br />
        <br />
        ...
        Commonwealth of Virginia , without regard to its conflict of law
        principles.
        <br />
        <br />
        ...
        will take place in United States of America , Virginia . Except as
        ...
        courts located in United States of America , Virginia , and the Parties
        ...
        <br />
        <br />
        <strong>21. LIMITATIONS OF LIABILITY</strong>
        <br />
        <br />
        ...
        <br />
        <br />
        <strong>22. INDEMNIFICATION</strong>
        <br />
        <br />
        ...
        <Link to="/terms">
          https://acewallscholarslearningonline.org/terms
        </Link>{" "}
        and our Privacy Policy at{" "}
        <Link to="/privacyPolicy">
          https://acewallscholarslearningonline.org/privacypolicy
        </Link>
        .
        <br />
        <br />
        If you have any questions or need assistance regarding our SMS
        communications, please email us at contact@acewallscholars.org or call
        at (+1)8046151845 .
        <br />
        <br />
        ...
        <br />
        <b>
          <li>Acewall Scholars</li>
          <li>1072 Timber Trace Road</li>
          <li>Powhatan , VA 23139</li>
          <li>United States</li>
          <li>Phone: (+1)8046151845</li>
          <li>contact@acewallscholars.org</li>
        </b>
        <br />
        <br />
        <br />
