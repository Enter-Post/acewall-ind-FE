  ...
  return (
    <>
      ...
      <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
        ...
        <div className="w-full sm:w-1/2">
          <Label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gender Identification</Label>
          <RadioGroup
          ...
          >
            {["Male", "Female", "Non-binary", "Other"].map((gender) => (
              <div key={gender} className="flex items-center space-x-2">
                ...
                <Label htmlFor={gender.toLowerCase()} className="text-sm text-gray-900 dark:text-white">
                  {gender}
                </Label>
              </div>
            ))}
