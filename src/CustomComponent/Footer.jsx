    ...
    <footer className="px-4 divide-y bg-gray-800 text-white mt-20 dark:bg-black dark:text-white">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
            <div className="flex items-center justify-center rounded-full w-[90%] dark:bg-violet-600">
              <Link className="flex title-font items-center md:justify-start justify-center text-gray-900">
                <img src={acewallscholarslogo} alt="" className="" />
              </Link>
            </div>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <ul className="space-y-1">
              ...
              <li>
                <a rel="noopener noreferrer" href="https://www.acewallscholars.org/about">About us</a>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              ...
              <a rel="noopener noreferrer" href="https://youtube.com/channel/UCR7GG6Dvnuf6ckhTo3wqSIQ" title="Youtube" className="flex 
              items-center p-1">
                <Youtube/>
              </a>
              <a rel="noopener noreferrer" href="https://twitter.com/AcewallScholars" title="Youtube" className="flex 
              items-center p-1">
                <X/>
              </a>
              <a rel="noopener noreferrer" href="contact@acewallscholars.org" title="Youtube" className="flex 
              items-center p-1">
                <Mail/>
              </a>
              <a rel="noopener noreferrer" href="https://instagram.com/acewallscholarsonline/" title="Instagram" className="flex items-center p-1">
