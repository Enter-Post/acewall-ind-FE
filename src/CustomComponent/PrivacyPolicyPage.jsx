    ...
    <section className="bg-white text-gray-800 py-8 px-4" style={style}>
      ...
      <div className="">
        <div className="text-sm leading-6 pr-4">
          ...
          in litigation in which we are involved. Vital Interests. We may
          ...
          situations involving potential threats to the safety of any person. If
          you are located in Canada, this section applies to you. We may process
          ...
          communicating with next of kin If we have reasonable grounds to
          ...
          province If disclosure is required to comply with a subpoena, warrant,
          court order, or rules of the court relating to the production of
          records If it was produced by an individual in the course of their
          ...
          account , prevent crashes, fix bugs, save your preferences, and assist
          with basic site functions. We also permit third parties and service
          ...
          websites. To the extent these online tracking technologies are deemed
          to be a "sale"/"sharing" (which includes targeted advertising, as
          ...
          HAVE SPECIFIC PRIVACY RIGHTS? " Specific information about how we use
          ...
          make public on such a social media platform. We will use the
          ...
          may share your personal information (see " WHEN AND WITH WHOM DO WE
          SHARE YOUR PERSONAL INFORMATION? " above), in and other countries. If
          you are a resident in the European Economic Area (EEA), United Kingdom
          (UK), or Switzerland, then these countries may not necessarily have
          data protection laws or other similar laws as comprehensive as those
          ...
          under 18 years of age . We do not knowingly collect, solicit data
          ...
          country, province, or state of residence. In some regions (like the
          ...
          HOW CAN YOU CONTACT US ABOUT THIS NOTICE? " below. We will consider
          ...
          right to complain to your Member State data protection authority or UK
          data protection authority . If you are located in Switzerland, you may
          ...
          <br />
          <i>
            In Short: If you are a resident of , you may have the right to
          ...
          the agent will need to provide a written and signed permission from
